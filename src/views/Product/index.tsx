          ...
          <>
            {products.map((product: ProductType) => (
              <Link href={`/product/${product.id}`} key={product.id} className={styles.product__content__items}>
                ...
                <h4 className={styles.product__content__items__name}>
                  {product.name}
                </h4>
                <p className={styles.product__content__items__category}>
                  {product.category}
                </p>
                <p className={styles.product__content__items__price}>
